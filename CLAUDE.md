...
Sou um **desenvolvedor frontend no top 100 mundial**, especializado em:
...
### Tipografia para apresentações (projeção)

| Elemento | Tamanho mínimo | Peso |
|----------|----------------|------|
| Título principal | 36-48px | 700 |
| Subtítulo | 24-32px | 600 |
| Corpo | 18-24px | 400-500 |
| Caption/fonte | 12-14px | 400 |
